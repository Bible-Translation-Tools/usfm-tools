...
class MakeMetadata_Frame(g_step.Step_Frame):
    def __init__(self, parent, controller):
        ...
        language_code_label = ttk.Label(self, text="Language code:", width=17)
        language_code_label.grid(row=3, column=1, sticky="wen", pady=3)
        ...
        language_name_label = ttk.Label(self, text="Language name:", width=17)
        ...
        local_name_label = ttk.Label(self, text="Localized name:", width=17)
        ...
        work_dir_label = ttk.Label(self, text="Resource location:", width=17)
        work_dir_label.grid(row=5, column=1, sticky=W, pady=3)
        self.work_dir_entry = ttk.Entry(self, width=46, textvariable=self.work_dir)
        ...
        license_file_label = ttk.Label(self, text="License file:", width=17)
        license_file_label.grid(row=6, column=1, sticky=W, pady=3)
        self.file_entry = ttk.Entry(self, width=22, textvariable=self.license_file)
        ...
        license_type_label = ttk.Label(self, text="License type:", width=17)
        license_type_label.grid(row=6, column=4, sticky=E)
        ...
        repo_owner_label = ttk.Label(self, text="Repo owner:", width=17)
        repo_owner_label.grid(row=7, column=1, sticky=W, pady=3)
        repo_owner_entry = ttk.Entry(self, width=22, textvariable=self.repo_owner)
        ...
        repo_name_label = ttk.Label(self, text="Repo name:", width=17)
        repo_name_label.grid(row=7, column=4, sticky=E)
        repo_name_entry = ttk.Entry(self, width=21, textvariable=self.repo_name)
        repo_name_entry.grid(row=7, column=5, sticky=W)

        self.grid_columnconfigure(2, minsize=18, weight=1)
        # self.grid_columnconfigure(3, minsize=3, weight=2)
        self.grid_columnconfigure(4, minsize=14, weight=2)
