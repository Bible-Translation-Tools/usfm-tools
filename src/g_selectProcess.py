...
class Select_Frame(g_step.Step_Frame):
    def __init__(self, parent, controller):
        ...
        process2_rb = ttk.Radiobutton(self, text='Convert Word documents to USFM', variable=self.process,
                                      command=self._onRbChange, value='Word2text')
...
"This process merges text files generated by BTT-Writer and converts them to USFM.\n\n\
...
The resulting USFM file(s) need to be verified and probably cleaned up a bit.")
            case 'Word2text':
                self.message_area.insert('end',
"This process converts Word .docx files to USFM files. \
It is a multi-step process that will involve some manual editing along the way. \
Follow the prompts.")
            case 'Plaintext2Usfm':
                self.message_area.insert('end',
