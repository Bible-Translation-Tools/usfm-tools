...
@pytest.mark.parametrize('text, expected',
    [
        ...
        (r'\v 22 v 22 Taba tiniharule', r'\v 22 Taba tiniharule'),
        (r'\ v 23 v 23 Taba tiniharule', r'\v 23 Taba tiniharule'),
    ])
...
@pytest.mark.parametrize('text, verserange, expected',
    [
        ...
        (r'\v 3 Usetano akhambula, "Ingave uveve', range3, r'\v 3 Usetano akhambula, "Ingave uveve'),
